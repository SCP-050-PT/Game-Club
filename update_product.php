...
<body>
    ...
    <!-- Форма обновления данных о товаре -->
            ...
            <div class="form">
                <form action="includes/update.php" method="post">
                    ...
                    <div class="form_item">
                        ...
                        <input type="text" name="product_title" id="product_title_area" value="<?= $product['title'] ?>">
                    </div>
                    ...
                    <div class="form_item">
                        ...
                        <textarea name="discription" id="discription_area" cols="30" rows="10"><?= $product['discription'] ?></textarea>
                    </div>

                    <div class="form_item">
                        <label for="price_area">Цена</label>
                        <input type="number" name="price" id="price_area" value="<?= $product['price'] ?>">
                    </div>
                    <button type="submit">Изменить сведения о товаре</button>
                </form>
            </div>
        </div>
    </div>
